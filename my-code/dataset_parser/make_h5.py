...
# parser.add_argument("--gtpath", required=True, default="..\\dataset\\gtfine",help="path of gtFine folder.")    #--gtpath gtpath
#
...
def get_data(mode):
    if mode == 'train' or mode == 'val' or mode == 'test':
        ...
        tmp_img_folder_path = img_folder_path+'/'+mode
        # tmp_gt_folder_path = os.path.join(gt_folder_path, mode)
        tmp_gt_folder_path = gt_folder_path+'/'+mode
